...
weights_path = "Models/yolov3.weights" #download from -> https://pjreddie.com/media/files/yolov3.weights
output_path = "Models/yolo.h5"
plot_model = "store_true"
weights_only = "store_true"
